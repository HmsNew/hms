...
from HmsRobot.services.keyboard import Ikb
from HmsRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from HmsRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from HmsRobot.services.types import InlineQueryResultCachedDocument
from HmsRobot.modules.info import get_chat_info, get_user_info
from HmsRobot.modules.music import download_youtube_audio
from HmsRobot.utils.functions import test_speedtest
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/hms_0bot"),
        InlineKeyboardButton(
...
async def music_inline_func(answers, query):
    chat_id = -1001592259671
    group_invite = "https://t.me/+GAq9ljePqT01MTZi"
    try:
        messages = [
            m
