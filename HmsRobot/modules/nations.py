...
from HmsRobot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from HmsRobot.modules.helper_funcs.extraction import extract_user
from HmsRobot.modules.log_channel import gloggable
from HmsRobot.modules.sql import nation_sql as sql
from HmsRobot.modules.helper_funcs.decorators import HmsRobotcmd
...
@HmsRobotcmd(command='addsupport')
@sudo_plus
@gloggable
def addsupport(
    update: Update,
...
@HmsRobotcmd(command='addwhitelist')
@sudo_plus
@gloggable
...
@HmsRobotcmd(command='addsardegna')
@sudo_plus
@gloggable
...
@HmsRobotcmd(command='removesudo')
@dev_plus
@gloggable
...
@HmsRobotcmd(command='removesupport')
@sudo_plus
@gloggable
...
@HmsRobotcmd(command='removewhitelist')
@sudo_plus
@gloggable
...
@HmsRobotcmd(command='removesardegna')
@sudo_plus
@gloggable
...
@HmsRobotcmd(command=["supportlist", "sakuras"])
@whitelist_plus
...
@HmsRobotcmd(command=["sudolist", "royals"])
@whitelist_plus
...
@HmsRobotcmd(command=["devlist", "eagle"])
@whitelist_plus
