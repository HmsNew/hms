...
from HmsRobot.modules.sql import SESSION, BASE
...
class FloodControl(BASE):
    ...
    def __repr__(self):
        return "<السيطرة على الفيضانات ل %s>" % self.chat_id
...
class FloodSettings(BASE):
    ...
    def __repr__(self):
        return "<{} سوف ينفذ {} للفيضانات.>".format(self.chat_id, self.flood_type)
