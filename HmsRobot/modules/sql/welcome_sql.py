...
DEFAULT_WELCOME_MESSAGES = [
    "{first} سيد الناس و عم الشباب و الرياضه وصل",  # Discord welcome messages copied
    "اخويا و ابن جهتي وصل اجدعان 😂 {first}",
    "نورت يزميلي دا جروبك بس اتفاعل كده و متراقبش فصمت 🙂❤️, {first}.",
    "{first} !حبيب الملاين و عم الناس 😹🤍",
    "{first} نورت يشق بص علي قواعد الروم يقلبي و منورنا ❤️.",
    "اهلا, {first}. كنا نتوقع منك ( ͡° ͜ʖ ͡°)",
    "اهلا, {first}. ياريت تكون جايب بيتزا معاك .",
    "اهلا, {first}. اترك أسلحتك عند الباب.",
]
DEFAULT_GOODBYE_MESSAGES = [
    "{first} هفتقدك يصحبي.",
    "{first} الوداع يصحبي.",
    "{first} ليه كده تمشي و تسيبنا.",
    "{first} حركه وحشه منك دي هاه.",
    "{first} تسيبنا دا احنا كنا هنلعب دلوقتي.",
    "{first} المكان هيبقا وحش من غيرك.",
    "{first} لقيت حد احسن مننا هاه.",
    "كنت منورنا الشويه دول, {first}!",
    "قضينا وقت جميل كلنا بوجودك {first}.",
    "زعلان منك تمشي و تسيبني, {first}.",
    "الوداع يا اغلي حبيب, {first}.",
    "باي {first}! هتوحشني هاه :')",
    "باي {first}! انت مجنون حد يمشي و يسيبنا.",
    "طيب متروحش مكان تاني بقا هاه, {first}!",
    "حظ سعيد و بالتوفيق يارب الجروب الي تروحو يولع بيك {first}!",
    "مع السلامه يروحي هبكي {first}. !",
    "الكلام دا بجد دا مشي و سابنا, {first}!.",
    "{first}. انتو هتسكتو اجدعان هتسيبوه يمشي كده هاتوه من قفا امو .",
    "طيب براحتك بالسلامه, {first}?",
    "كان عندي ليك صوره حلوه",
    "باي يحبب!",
    "ابقي تعالي بقي",
    "خلي بالك من نفسك",
    "هترجعلنا تاني ع فكره",
    "بشوقك الي يريحك باي",
    "هتوحنا يا توني هتوحشنا يا حبيب قلبي",
    "اخلع بالسلامه",
    "حبيبي يبا سلام ! مين دا الي مشي اجدعان",
    "طب بالسلامه انت اصحبي ! ابو تقل دم امك مبحبوش الشخص دا",
]
...
class Welcome(BASE):
    ...
    def __repr__(self):
        return "<Chat {} ينبغي الترحيب بالمستخدمين الجدد: {}>".format(
            self.chat_id,
            self.should_welcome,
        )
...
class CleanServiceSetting(BASE):
    ...
    def __repr__(self):
        return "<Chat استخدام خدمة نظيفة ({})>".format(self.chat_id)
