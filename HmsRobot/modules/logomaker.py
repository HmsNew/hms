...
from HmsRobot import telethn as tbot, ubot2
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("./HmsRobot/resources/fonts/*")
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="Logo by [Caty New](https://t.me/Source1bot)",
    ...
    if os.path.exists(font_):
        if not font_.startswith("./HmsRobot/resources/fonts"):
            os.remove(font_)
