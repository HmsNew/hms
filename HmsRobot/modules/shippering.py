...
from HmsRobot.utils.dbfunc import get_couple, save_couple
    ...
    try:
        ...
        if not is_selected:
            ...
            if len(list_of_users) < 2:
                await message.reply_text("لا يوجد عدد كافٍ من المستخدمين")
                return
            ...
            couple_selection_message = f"""**الكابلز اليوم هما 😂:**
{c1_mention} + {c2_mention} = ❤️
__قد يتم اختيار زوجين جديدين في اليوم في الساعة 12 صباحًا {tomorrow}__"""
...
__help__ = """
❂ /couples - لاختيار زوجين من اليوم
